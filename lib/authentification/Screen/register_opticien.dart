...
class RegisterOpticien extends StatefulWidget {

  @override
  _RegisterOpticien createState() => new _RegisterOpticien();
}

class _RegisterOpticien extends State<RegisterOpticien>  with SingleTickerProviderStateMixin {
